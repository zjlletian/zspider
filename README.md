# ZSpider分布式网站爬虫  开发日志 verison 9.1.5
...
--------------------- 2016-3-31 version 9.1.5 ---------------------

1.DashBoard增加任务结果统计。

--------------------- 2016-3-27 version 9.1.0 ---------------------

1.支持rules文件配置任务。

--------------------- 2016-3-25 version 9.0.0 ---------------------

1.定时清理新链接队列中积压的无效链接，增加转储的成功率。

2.增加转储队列进程一次读取新链接的数量，减少访问次数，降低数据库压力，大幅度提升转储效率。

3.取消新链接队列表分区，提升全表扫描速度。

--------------------- 2016-3-20 version 8.9.1 ---------------------

1.任务并行数量可以单独设置。

2.细化单个爬虫的进程数量显示。

3.改进新连接转储机制中快速批量插入的方案。

--------------------- 2016-3-17 version 8.8.0 ---------------------

1.优化实时任务详情的显示，每一个进度条都采用异步事件来控制，提升性能与体验。

--------------------- 2016-3-14 version 8.7.1 ---------------------

1.记录各个爬虫机器的负载情况,预留展示面板。

--------------------- 2016-3-13 version 8.6.0 ---------------------

1.增加debug模式时显示提交任务的各部分耗时。

2.将ik分词器作为html默认中文分词。

--------------------- 2016-3-11 version 8.5.1 ---------------------

1.爬虫向服务器报告正在执行的进程数量。

2.爬虫进程管理器重启进程时将会一次性启动进程至最大进程数。

--------------------- 2016-3-10 version 8.4.1 ---------------------

1.废弃不靠谱的setTimeout函数，使用独立子进程监视每个任务的执行时间。

2.使用curl方式代替es-php,控制每次请求的时间。

3.增加平均新连接数的显示,增加爬虫默认并发数量。

--------------------- 2016-3-9 version 8.3.0 ---------------------

1.补齐折线图中没有数据的时间。

2.增加单文档处理周期的展示。

--------------------- 2016-3-8 version 8.2.0 ---------------------

1.增加每分钟爬取文档数量展示。

--------------------- 2016-3-7 version 8.1.0 ---------------------

1.优化DashBoard侧边栏显示，增加颜色样式，查看文档更新日志与队列任务控制按钮。

--------------------- 2016-3-7 version 8.0.0 ---------------------

1.优化DashBoard显示，增加文档数量信息的展示。

--------------------- 2016-3-6 version 7.6.0 ---------------------

1.提供Debug模式。

2.将原有EsOpreator改为Storager，并增加Mongodb-river方案。

--------------------- 2016-3-5 version 7.5.0 ---------------------
...
--------------------- 2016-3-4 version 7.2.0 ---------------------

1.使用两种方式检测字符集，避免当meta中不包含字符集信息时phpquery出错的问题。

--------------------- 2016-3-4 version 7.1.0 ---------------------
